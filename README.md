...
Before you start being a key contributor to the project please take a look at the [contributing guidelines](CONTRIBUTING.md)
...
Remember to abide by the [Code of Conduct](CODE_OF_CONDUCT.md).
