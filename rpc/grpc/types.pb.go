...
func (*RequestPing) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_d6023ab2b8d34996, []int{0}
}
...
func (*RequestBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_d6023ab2b8d34996, []int{1}
}
...
func (*ResponsePing) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_d6023ab2b8d34996, []int{2}
}
...
func (*ResponseBroadcastTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_d6023ab2b8d34996, []int{3}
}
...
func init() { proto.RegisterFile("rpc/grpc/types.proto", fileDescriptor_types_d6023ab2b8d34996) }
func init() { golang_proto.RegisterFile("rpc/grpc/types.proto", fileDescriptor_types_d6023ab2b8d34996) }

var fileDescriptor_types_d6023ab2b8d34996 = []byte{
