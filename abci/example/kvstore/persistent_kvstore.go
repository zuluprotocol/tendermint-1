...
func (app *PersistentKVStoreApplication) GetSnapshotChunk(
	req types.RequestGetSnapshotChunk) types.ResponseGetSnapshotChunk {
	return types.ResponseGetSnapshotChunk{}
}
