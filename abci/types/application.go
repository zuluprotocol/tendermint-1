...
type Application interface {
	...
	GetSnapshotChunk(RequestGetSnapshotChunk) ResponseGetSnapshotChunk       // Fetch a snapshot chunk
...
func (BaseApplication) GetSnapshotChunk(req RequestGetSnapshotChunk) ResponseGetSnapshotChunk {
	return ResponseGetSnapshotChunk{}
}
...
func (app *GRPCApplication) GetSnapshotChunk(
	ctx context.Context, req *RequestGetSnapshotChunk) (*ResponseGetSnapshotChunk, error) {
	res := app.app.GetSnapshotChunk(*req)
	return &res, nil
}
