...
func (app *localClient) GetSnapshotChunkAsync(req types.RequestGetSnapshotChunk) *ReqRes {
	app.mtx.Lock()
	defer app.mtx.Unlock()

	res := app.Application.GetSnapshotChunk(req)
	return app.callback(
		types.ToRequestGetSnapshotChunk(req),
		types.ToResponseGetSnapshotChunk(res),
	)
}
...
func (app *localClient) GetSnapshotChunkSync(
