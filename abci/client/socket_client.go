...
func (cli *socketClient) GetSnapshotChunkAsync(req types.RequestGetSnapshotChunk) *ReqRes {
	return cli.queueRequest(types.ToRequestGetSnapshotChunk(req))
}
...
func (cli *socketClient) GetSnapshotChunkSync(
	req types.RequestGetSnapshotChunk) (*types.ResponseGetSnapshotChunk, error) {
	reqres := cli.queueRequest(types.ToRequestGetSnapshotChunk(req))
	cli.FlushSync()
